...
@Config
@Autonomous(name = "RoadrunnerAccuracyNoCorrections", group = "Autonomous")
public class RoadrunnerAccuracyNoCorrections extends LinearOpMode {
    //@Config
    ...
    public static double Traj4Heading = 180;
    public static double Traj5X = 0;
    public static double Traj5Y = 0;
    public static double Traj6Heading = 0;
    ...
    public RoadrunnerAccuracyNoCorrections() {
    }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder Traj1 = drive.actionBuilder(new Pose2d(drive.pose.position.x,drive.pose.position.y,drive.pose.heading.toDouble()))
                .strafeTo(new Vector2d(Traj1X,RRInitPosY));
        TrajectoryActionBuilder Traj2 = drive.actionBuilder(new Pose2d(drive.pose.position.x,drive.pose.position.y,drive.pose.heading.toDouble()))
                .turnTo(Math.toRadians(Traj2Heading));
        TrajectoryActionBuilder Traj6 = drive.actionBuilder(new Pose2d(drive.pose.position.x,drive.pose.position.y,drive.pose.heading.toDouble()))
                .turnTo(Math.toRadians(Traj6Heading));
        TrajectoryActionBuilder Traj3 = drive.actionBuilder(new Pose2d(drive.pose.position.x,drive.pose.position.y,drive.pose.heading.toDouble()))
                .strafeTo(new Vector2d(Traj1X,Traj3Y));
        TrajectoryActionBuilder Traj4 = drive.actionBuilder(new Pose2d(drive.pose.position.x,drive.pose.position.y,drive.pose.heading.toDouble()))
                .turnTo(Math.toRadians(Traj4Heading));
        TrajectoryActionBuilder Traj5 = drive.actionBuilder(new Pose2d(drive.pose.position.x,drive.pose.position.y,drive.pose.heading.toDouble()))
                .setTangent(/*drive.pose.heading.toDouble()*/Math.toRadians(270))
                .splineToConstantHeading(new Vector2d(Traj5X,Traj5Y),Math.toRadians(180));
        //TrajectoryActionBuilder Traj6 =  drive.actionBuilder(drive.pose)
        //        .turnTo(Math.toRadians(Traj6Heading));
